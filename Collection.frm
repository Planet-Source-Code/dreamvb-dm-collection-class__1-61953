...
Private Sub cmdabout_Click()
    MsgBox "Collection Class by DreamVb" _
    & vbCrLf & "Please vote if you find this usfill", vbInformation
...
Dim x As Long
    ...
    For x = DMCollection.Lower To 5
        DMCollection.Add "Number " & x, x
    Next
